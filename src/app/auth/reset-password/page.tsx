  ...
  return (
    <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-10 relative z-10 border border-slate-100">
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 mb-3 tracking-tight">Set New Password</h1>
        <p className="text-base text-slate-500 font-medium">Please choose a strong password for your account.</p>
      </div>
...
export default function ResetPasswordPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden p-4 sm:p-8">
      ...
      <Suspense fallback={<div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-10 relative z-10 border border-slate-100 flex justify-center"><div className="w-8 h-8 border-4 border-green-500/30 border-t-green-500 rounded-full animate-spin" /></div>}>
        <ResetPasswordForm />
      </Suspense>
    </div>
  );
