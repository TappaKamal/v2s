      ...
      <Card className="border-border/30">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between py-2 border-t border-border/20">
            ...
            <span className="text-sm font-medium">{user.timezone || 'Asia/Kolkata'}</span>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between py-2 border-t border-border/20">
            ...
            <div className="flex gap-1.5 flex-wrap justify-end">
              <Badge variant="outline" className="text-[10px]">Prioritization</Badge>
              <Badge variant="outline" className="text-[10px]">Scheduling</Badge>
              <Badge variant="outline" className="text-[10px]">Voice</Badge>
              <Badge variant="outline" className="text-[10px]">Analytics</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
